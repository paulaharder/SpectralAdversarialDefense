...
testset = torch.load('./data/clean_data_cif')
...
torch.save(images,'./data/adversarials/images_'+attack_method)
torch.save(images_advs,'./data/adversarials/images_adv_'+attack_method)
