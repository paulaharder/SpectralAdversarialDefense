...
parser.add_argument("--attack_train", default='fgsm', help="the attack method which created the adversarial examples you want to use. Either fgsm, bim, pgd, df or cw")
parser.add_argument("--attack_eval", default='fgsm', help="the attack method which created the adversarial examples you want to use. Either fgsm, bim, pgd, df or cw")
...
#choose attack
attack_train = args.attack_train
attack_eval = args.attack_eval
detector = args.detector
mode = args.mode
net = args.net
print('Attack transfer between'+attack_train+attack_eval)
#load characteristics
print('Loading characteristics...')
characteristics = np.load('../data/characteristics/'+net+'_'+attack_eval+'_'+detector+'.npy',allow_pickle=True)
characteristics_adv = np.load('../data/characteristics/'+net+'_'+attack_eval+'_'+detector+'_adv.npy',allow_pickle=True)
...
#save classifier
filename = '../data/detectors/LR_'+attack_train+'_'+detector+'_'+mode+'_'+net+'.sav'
